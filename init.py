__help__ = "Модуль безопасности sec"
...
[bold]Использование:[/bold]
  ...
  apm sec intrusion init                        Установить только IDS/IPS alias-командой
  apm sec logs init                             Подготовить директорию логов
  apm sec logs analyze [--template PATTERN]     Проанализировать журналы безопасности
